...
class OS
{
    private:
        ...
        char buffer[40];
    public:
        void init();        // Initialize the OS
        void LOAD();        // Load program from file
        void Execute();     // Execute the loaded program
        void MOS();         // Master Mode I/O Operation
...
int main()
{
    ...
    os.infile.open("input5.txt", ios::in);
    os.outfile.open("output5.txt", ios::out);
